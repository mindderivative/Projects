---
title: "Using Lightmap global illumination"
source: "https://docs.godotengine.org/en/stable/tutorials/3d/global_illumination/using_lightmap_gi.html"
created: 2026-06-20
description: "Baked lightmaps are a workflow for adding indirect (or fully baked) lighting to a scene. Unlike the VoxelGI and SDFGI approaches, baked lightmaps work fine on low-end PCs and mobile devices, as the..."
words: 4147
---
...
Unlike VoxelGI and SDFGI, baked lightmaps are completely static. Once baked, they can't be modified at all. They also don't provide the scene with reflections, so using [Reflection probes](https://docs.godotengine.org/en/stable/tutorials/3d/global_illumination/reflection_probes.html#doc-reflection-probes) together with it on interiors (or using a Sky on exteriors) is a requirement to get good quality.
...
Baking lightmaps will also reserve baked materials' UV2 slot, which means you can no longer use it for other purposes in materials (either in the built-in [Standard Material 3D and ORM Material 3D](https://docs.godotengine.org/en/stable/tutorials/3d/standard_material_3d.html#doc-standard-material-3d) or in custom shaders).
...
> [!note] See also
> Not sure if LightmapGI is suited to your needs? See [Which global illumination technique should I use?](https://docs.godotengine.org/en/stable/tutorials/3d/global_illumination/introduction_to_global_illumination.html#doc-introduction-to-global-illumination-comparison) for a comparison of GI techniques available in Godot 4.

## Visual comparison

![LightmapGI disabled.](https://docs.godotengine.org/en/stable/_images/gi_none.webp)

LightmapGI disabled. 

![LightmapGI enabled (with indirect light baked only).](https://docs.godotengine.org/en/stable/_images/gi_lightmap_gi_indirect_only.webp)
...
![LightmapGI enabled (with direct and indirect light baked).](https://docs.godotengine.org/en/stable/_images/gi_lightmap_gi_direct_and_indirect.webp)
...
![../../../_images/lightmap_gi_comparison.png](https://docs.godotengine.org/en/stable/_images/lightmap_gi_comparison.png)
...
![../../../_images/lightmap_gi_mesh_menu.webp](https://docs.godotengine.org/en/stable/_images/lightmap_gi_mesh_menu.webp)
...
![../../../_images/lightmap_gi_blender.webp](https://docs.godotengine.org/en/stable/_images/lightmap_gi_blender.webp)

Then import the 3D scene normally. Remember you will need to set the texture size on the mesh after import.

![../../../_images/lightmap_gi_lmsize.webp](https://docs.godotengine.org/en/stable/_images/lightmap_gi_lmsize.webp)
...
> [!note] Note
> This option is only available for primitive meshes such as [BoxMesh](https://docs.godotengine.org/en/stable/classes/class_boxmesh.html#class-boxmesh), [CylinderMesh](https://docs.godotengine.org/en/stable/classes/class_cylindermesh.html#class-cylindermesh), [PlaneMesh](https://docs.godotengine.org/en/stable/classes/class_planemesh.html#class-planemesh), etc.
...
Since Godot 4.4, you can [convert a CSG node and its children to a MeshInstance3D](https://docs.godotengine.org/en/stable/tutorials/3d/csg_tools.html#doc-csg-tools-converting-to-mesh-instance-3d). This can be used to bake lightmaps on a CSG node by following these steps:
...
![../../../_images/lightmap_gi_uvchannel.webp](https://docs.godotengine.org/en/stable/_images/lightmap_gi_uvchannel.webp)
...
![../../../_images/lightmap_gi_scene.webp](https://docs.godotengine.org/en/stable/_images/lightmap_gi_scene.webp)
...
![../../../_images/lightmap_gi_use.webp](https://docs.godotengine.org/en/stable/_images/lightmap_gi_use.webp)
...
![../../../_images/lightmap_gi_bake_mode.webp](https://docs.godotengine.org/en/stable/_images/lightmap_gi_bake_mode.webp)
...
![../../../_images/lightmap_gi_omnilight_size.png](https://docs.godotengine.org/en/stable/_images/lightmap_gi_omnilight_size.png)
...
![../../../_images/lightmap_gi_bake.webp](https://docs.godotengine.org/en/stable/_images/lightmap_gi_bake.webp)
...
- **Shadowmask Mode:** If set to a mode other than **None**, the first DirectionalLight3D in the scene with the **Dynamic** global illumination mode will have its static shadows baked to a separate texture called a *shadowmask*. This can be used to allow distant static objects to cast shadows onto other static objects regardless of the distance from the camera. See the for further details.
...
- **Use Denoiser:** If enabled, uses a denoising algorithm to make the lightmap significantly less noisy. This increases bake times and can occasionally introduce artifacts, but the result is often worth it. See for more information.
...
![Comparison between shadowmask modes](https://docs.godotengine.org/en/stable/_images/lightmap_gi_shadowmask.webp)
...
![Comparison between denoising disabled and enabled](https://docs.godotengine.org/en/stable/_images/lightmap_gi_denoiser_comparison.webp)
...
![Comparison between JNLM denoiser strength values](https://docs.godotengine.org/en/stable/_images/lightmap_gi_denoiser_jnlm_strength.webp)
...
![Comparison between JNLM and OIDN denoisers](https://docs.godotengine.org/en/stable/_images/lightmap_gi_denoiser_jnlm_vs_oidn.webp)
...
- **Manual:** In addition or as an alternative to generating probes automatically, you can add light probes manually by adding [LightmapProbe](https://docs.godotengine.org/en/stable/classes/class_lightmapprobe.html#class-lightmapprobe) nodes to the scene. This can be used to improve lighting detail in areas frequently travelled by dynamic objects. After placing LightmapProbe nodes in the scene, you must bake lightmaps again for them to be effective.
