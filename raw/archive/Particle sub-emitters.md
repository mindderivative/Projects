...
source: "https://docs.godotengine.org/en/stable/tutorials/3d/particles/subemitters.html"
created: 2026-06-20
description: "Chained sub-emitters Sometimes a visual effect cannot be created with a single particle system alone. Sometimes a particle system needs to be spawned as a response to something that happens in anot..."
words: 533
---
![Chained sub-emitters](https://docs.godotengine.org/en/stable/_images/particle_sub_chain.webp)
...
![Assign sub-emitter](https://docs.godotengine.org/en/stable/_images/particle_sub_assign.webp)

Click to assign a sub-emitter... 

![List particle systems](https://docs.godotengine.org/en/stable/_images/particle_sub_list.webp)
