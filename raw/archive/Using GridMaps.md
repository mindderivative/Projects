...
source: "https://docs.godotengine.org/en/stable/tutorials/3d/using_gridmaps.html#using-gridmap-in-code"
created: 2026-06-20
description: "Introduction: Gridmaps are a tool for creating 3D game levels, similar to the way TileMap works in 2D. You start with a predefined collection of 3D meshes (a MeshLibrary) that can be placed on a gr..."
words: 1239
---
## Introduction

[Gridmaps](https://docs.godotengine.org/en/stable/classes/class_gridmap.html#class-gridmap) are a tool for creating 3D game levels, similar to the way [TileMap](https://docs.godotengine.org/en/stable/tutorials/2d/using_tilemaps.html#doc-using-tilemaps) works in 2D. You start with a predefined collection of 3D meshes (a [MeshLibrary](https://docs.godotengine.org/en/stable/classes/class_meshlibrary.html#class-meshlibrary)) that can be placed on a grid, as if you were building a level with an unlimited amount of Lego blocks.

Collisions and navigation can also be added to the meshes, just like you would do with the tiles of a tilemap.

## Example project

To learn how GridMaps work, start by downloading the sample project: [gridmap\_starter.zip](https://github.com/godotengine/godot-docs-project-starters/releases/download/latest-4.x/gridmap_starter.zip).
...
To begin, you need a [MeshLibrary](https://docs.godotengine.org/en/stable/classes/class_meshlibrary.html#class-meshlibrary), which is a collection of individual meshes that can be used in the gridmap. Open the "mesh\_library\_source.tscn" scene to see an example of how to set up the mesh library.

![../../_images/gridmap_meshlibrary1.webp](https://docs.godotengine.org/en/stable/_images/gridmap_meshlibrary1.webp)

As you can see, this scene has a [Node3D](https://docs.godotengine.org/en/stable/classes/class_node3d.html#class-node3d) node as its root, and a number of [MeshInstance3D](https://docs.godotengine.org/en/stable/classes/class_meshinstance3d.html#class-meshinstance3d) node children.
...
You can manually assign a [StaticBody3D](https://docs.godotengine.org/en/stable/classes/class_staticbody3d.html#class-staticbody3d) and [CollisionShape3D](https://docs.godotengine.org/en/stable/classes/class_collisionshape3d.html#class-collisionshape3d) to each mesh. Alternatively, you can use the "Mesh" menu to automatically create the collision body based on the mesh data.

![../../_images/gridmap_create_body.webp](https://docs.godotengine.org/en/stable/_images/gridmap_create_body.webp)
...
![../../_images/gridmap_mesh_scene.webp](https://docs.godotengine.org/en/stable/_images/gridmap_mesh_scene.webp)
...
Aside from this peculiarity, the lightmap baking process is the same as for any other 3D scene. See [Using Lightmap global illumination](https://docs.godotengine.org/en/stable/tutorials/3d/global_illumination/using_lightmap_gi.html#doc-using-lightmap-gi) for more information about lightmap baking.
...
- Be a [MeshInstance3D](https://docs.godotengine.org/en/stable/classes/class_meshinstance3d.html#class-meshinstance3d), which will become the MeshLibrary item. Only this visual mesh will be exported.
- Have a material, in the mesh's material slot, *not* the MeshInstance3D's material slots.
- Have up to one [StaticBody3D](https://docs.godotengine.org/en/stable/classes/class_staticbody3d.html#class-staticbody3d) child, for collision. The StaticBody3D should have one or more [CollisionShape3D](https://docs.godotengine.org/en/stable/classes/class_collisionshape3d.html#class-collisionshape3d) children.
- Have up to one [NavigationRegion3D](https://docs.godotengine.org/en/stable/classes/class_navigationregion3d.html#class-navigationregion3d) child, for navigation. The NavigationRegion3D can have one or more additional [MeshInstance3D](https://docs.godotengine.org/en/stable/classes/class_meshinstance3d.html#class-meshinstance3d) children, which can be baked for navigation, but won't be exported as a visual mesh.
...
![../../_images/gridmap_export.webp](https://docs.godotengine.org/en/stable/_images/gridmap_export.webp)
...
![../../_images/gridmap_mesh_library_inspector.webp](https://docs.godotengine.org/en/stable/_images/gridmap_mesh_library_inspector.webp)
...
The **Collision** options allow you to set the collision layer, collision mask, and priority for the entire grid. For more information on how those work see the [Physics](https://docs.godotengine.org/en/stable/tutorials/physics/index.html#doc-physics-index) section.
...
![../../_images/gridmap_mesh_library_settings.webp](https://docs.godotengine.org/en/stable/_images/gridmap_mesh_library_settings.webp)

### GridMap panel

At the bottom of the editor is the GridMap panel, which should have opened automatically when you added the GridMap node.

![../../_images/gridmap_panel.webp](https://docs.godotengine.org/en/stable/_images/gridmap_panel.webp)
...
![../../_images/gridmap_dropdown.webp](https://docs.godotengine.org/en/stable/_images/gridmap_dropdown.webp)
...
See [GridMap](https://docs.godotengine.org/en/stable/classes/class_gridmap.html#class-gridmap) for details on the node's methods and member variables.
