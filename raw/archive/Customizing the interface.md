...
source: "https://docs.godotengine.org/en/stable/tutorials/editor/customizing_editor.html"
created: 2026-06-19
description: "Godot's interface lives in a single window by default. Since Godot 4.0, you can split several elements to separate windows to better make use of multi-monitor setups. Moving and resizing docks..."
words: 1075
tags:
  - editor
  - interface
...
![Resizing a dock in the editor](https://docs.godotengine.org/en/stable/_images/editor_ui_resize_dock.webp)
...
![Moving a dock in the editor](https://docs.godotengine.org/en/stable/_images/editor_ui_move_dock.webp)
...
![Splitting the script editor to its own window](https://docs.godotengine.org/en/stable/_images/editor_ui_split_script_editor.webp)
...
![Splitting the shader editor to its own window](https://docs.godotengine.org/en/stable/_images/editor_ui_split_shader_editor.webp)
...
Editor layouts are saved to a file named `editor_layouts.cfg` in the configuration path of the [Editor data paths](https://docs.godotengine.org/en/stable/tutorials/io/data_paths.html#doc-data-paths-editor-data-paths).
...
![The Editor Settings window](https://docs.godotengine.org/en/stable/_images/editor_settings.webp)
...
See the [EditorSettings](https://docs.godotengine.org/en/stable/classes/class_editorsettings.html#class-editorsettings) class reference for a complete description of most editor settings. You can also hover an editor setting's name with the mouse in the Editor Settings to show its description.
