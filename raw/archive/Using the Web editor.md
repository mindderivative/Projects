...
source: "https://docs.godotengine.org/en/stable/tutorials/editor/using_the_web_editor.html"
created: 2026-06-19
description: "There is a Web editor you can use to work on new or existing projects. Browser support: The Web editor requires support for WebAssembly's SharedArrayBuffer. This is in turn required to support..."
words: 742
tags:
  - editor
  - web
...
> [!note] Note
> The web editor is in a preliminary stage. While its feature set may be sufficient for educational purposes, it is currently **not recommended for production work**. See below.
...
See [System requirements](https://docs.godotengine.org/en/stable/about/system_requirements.html#doc-system-requirements) for a list of supported web browsers. Mobile browsers are supported, but won't provide an ideal experience due to performance and input limitations.
...
> [!note] See also
> See the [list of open issues on GitHub related to the web editor](https://github.com/godotengine/godot/issues?q=is%3Aopen+is%3Aissue+label%3Aplatform%3Aweb+label%3Atopic%3Aeditor) for a list of known bugs.
