...
source: "https://docs.godotengine.org/en/stable/tutorials/3d/standard_material_3d.html#introduction"
created: 2026-06-20
description: "Introduction: StandardMaterial3D and ORMMaterial3D(Occlusion, Roughness, Metallic) are default 3D materials that aim to provide most of the features artists look for in a material, without the need..."
words: 4848
---
## Introduction
...
![../../_images/add_material.webp](https://docs.godotengine.org/en/stable/_images/add_material.webp)
...
![../../_images/spatial_material1.webp](https://docs.godotengine.org/en/stable/_images/spatial_material1.webp)
...
![../../_images/spatial_material12.png](https://docs.godotengine.org/en/stable/_images/spatial_material12.png)

> [!warning] Warning
> Alpha-blended transparency has several [limitations](https://docs.godotengine.org/en/stable/tutorials/3d/3d_rendering_limitations.html#doc-3d-rendering-limitations-transparency-sorting):
> 
...
While alpha scissor and alpha hash materials are faster to render than alpha-blended materials, they exhibit hard edges between opaque and transparent regions. While it's possible to use post-processing-based [antialiasing techniques](https://docs.godotengine.org/en/stable/tutorials/3d/3d_antialiasing.html#doc-3d-antialiasing) such as FXAA and TAA, this is not always desired as these techniques tend to make the final result look blurrier or exhibit ghosting artifacts.
...
![../../_images/spatial_material8.png](https://docs.godotengine.org/en/stable/_images/spatial_material8.png)
...
![../../_images/material_depth_draw.png](https://docs.godotengine.org/en/stable/_images/material_depth_draw.png)
...
![../../_images/spatial_material3.png](https://docs.godotengine.org/en/stable/_images/spatial_material3.png)
...
![../../_images/material_depth_test.webp](https://docs.godotengine.org/en/stable/_images/material_depth_test.webp)
...
![Three spheres showing the Per-Pixel, Per-Vertex, and Unshaded modes.](https://docs.godotengine.org/en/stable/_images/standard_material_shading_modes.webp)
...
![Two cubes with a brick texture, one shaded and one unshaded.](https://docs.godotengine.org/en/stable/_images/standard_material_shading_modes_textured.webp)
...
![../../_images/spatial_material6.webp](https://docs.godotengine.org/en/stable/_images/spatial_material6.webp)
...
![../../_images/spatial_material7.webp](https://docs.godotengine.org/en/stable/_images/spatial_material7.webp)
...
![../../_images/spatial_material4.webp](https://docs.godotengine.org/en/stable/_images/spatial_material4.webp)
...
![../../_images/spatial_material13.png](https://docs.godotengine.org/en/stable/_images/spatial_material13.png)
...
![../../_images/spatial_material14.png](https://docs.godotengine.org/en/stable/_images/spatial_material14.png)

## Emission

*Emission* specifies how much light is emitted by the material (keep in mind this does not include light surrounding geometry unless [VoxelGI](https://docs.godotengine.org/en/stable/tutorials/3d/global_illumination/using_voxel_gi.html#doc-using-voxel-gi) or [SDFGI](https://docs.godotengine.org/en/stable/tutorials/3d/global_illumination/using_sdfgi.html#doc-using-sdfgi) are used). This value is added to the resulting final image and is not affected by other lighting in the scene.

![../../_images/spatial_material15.png](https://docs.godotengine.org/en/stable/_images/spatial_material15.png)
...
![../../_images/spatial_material16.png](https://docs.godotengine.org/en/stable/_images/spatial_material16.png)
...
![../../_images/spatial_material_bentnormals.webp](https://docs.godotengine.org/en/stable/_images/spatial_material_bentnormals.webp)
...
![../../_images/spatial_material17.png](https://docs.godotengine.org/en/stable/_images/spatial_material17.png)
...
![../../_images/clearcoat_comparison.png](https://docs.godotengine.org/en/stable/_images/clearcoat_comparison.png)
...
![../../_images/spatial_material18.png](https://docs.godotengine.org/en/stable/_images/spatial_material18.png)
...
![../../_images/spatial_material19.png](https://docs.godotengine.org/en/stable/_images/spatial_material19.png)

## Height

Setting a height map on a material produces a ray-marched search to emulate the proper displacement of cavities along the view direction. This only creates an illusion of depth, and does not add real geometry — for a height map shape used for physics collision (such as terrain), see [HeightMapShape3D](https://docs.godotengine.org/en/stable/classes/class_heightmapshape3d.html#class-heightmapshape3d). It may not work for complex objects, but it produces a realistic depth effect for textures. For best results, *Height* should be used together with normal mapping.

![../../_images/spatial_material20.png](https://docs.godotengine.org/en/stable/_images/spatial_material20.png)
...
![../../_images/spatial_material21.png](https://docs.godotengine.org/en/stable/_images/spatial_material21.png)
...
![../../_images/spatial_material22.png](https://docs.godotengine.org/en/stable/_images/spatial_material22.png)
...
![../../_images/spatial_material23.png](https://docs.godotengine.org/en/stable/_images/spatial_material23.png)
...
![../../_images/spatial_material24.png](https://docs.godotengine.org/en/stable/_images/spatial_material24.png)
...
![../../_images/spatial_material25.png](https://docs.godotengine.org/en/stable/_images/spatial_material25.png)
...
The filtering method for the textures used by the material. See [this page](https://docs.godotengine.org/en/stable/classes/class_basematerial3d.html#class-basematerial3d-property-texture-filter) for a full list of options and their description.

### Repeat

if the textures used by the material repeat, and how they repeat. See [this page](https://docs.godotengine.org/en/stable/classes/class_basematerial3d.html#class-basematerial3d-property-texture-repeat) for a full list of options and their description.
...
- **Particle Billboard:** Most suited for particle systems, because it allows specifying [flipbook animation](https://docs.godotengine.org/en/stable/tutorials/3d/particles/process_material_properties.html#doc-process-material-properties-animation).
![../../_images/spatial_material9.webp](https://docs.godotengine.org/en/stable/_images/spatial_material9.webp)
...
![../../_images/spatial_material10.png](https://docs.godotengine.org/en/stable/_images/spatial_material10.png)
...
![../../_images/spatial_material11.png](https://docs.godotengine.org/en/stable/_images/spatial_material11.png)
...
Note that in Godot 4.5 onwards, stencil buffer-based outlines are available using the **Outline**. This can be used as an alternative to Grow for outlines.
...
![../../_images/spatial_material_proxfade.gif](https://docs.godotengine.org/en/stable/_images/spatial_material_proxfade.gif)
...
![../../_images/standart_material_distance_fade_pixel_alpha_mode.webp](https://docs.godotengine.org/en/stable/_images/standart_material_distance_fade_pixel_alpha_mode.webp)
...
![../../_images/standart_material_distance_fade_pixel_dither_mode.webp](https://docs.godotengine.org/en/stable/_images/standart_material_distance_fade_pixel_dither_mode.webp)

**Object Dither** mode: Like the previous mode, but the calculated transparency is the same across the entire object's surface.

![../../_images/standart_material_distance_fade_object_dither_mode.webp](https://docs.godotengine.org/en/stable/_images/standart_material_distance_fade_object_dither_mode.webp)
...
![../../_images/material_stencil.webp](https://docs.godotengine.org/en/stable/_images/material_stencil.webp)

Materials that write to the stencil buffer are always drawn in the transparent pass, so they are subject to the usual [transparency limitations](https://docs.godotengine.org/en/stable/tutorials/3d/3d_rendering_limitations.html#doc-3d-rendering-limitations-transparency-sorting).

> [!note] Note
> Like with the, for the stencil outline to work as expected, the mesh must have connected faces with shared vertices, or "smooth shading". If the mesh has disconnected faces with unique vertices, or "flat shading", the mesh will appear to have gaps when using a stencil outline.
> 
...
Objects are sorted by an opaque/transparent queue, then [render\_priority](https://docs.godotengine.org/en/stable/classes/class_material.html#class-material-property-render-priority), with higher priority being drawn later. Transparent objects are also sorted by depth.
