...
source: "https://docs.godotengine.org/en/stable/tutorials/3d/high_dynamic_range.html#introduction"
created: 2026-06-20
description: "Introduction: Normally, an artist does all the 3D modeling, then all the texturing, looks at their awesome looking model in the 3D modeling software and says \"looks fantastic, ready for integr..."
words: 841
---
...
> [!note] Note
> Godot supports high dynamic range *output*. You can read more about this on the [HDR output](https://docs.godotengine.org/en/stable/tutorials/rendering/hdr_output.html#doc-hdr-output) page.
> 
...
![../../_images/hdr_gamma.png](https://docs.godotengine.org/en/stable/_images/hdr_gamma.png)
...
After all the rendering is done, the scene linear render requires transforming to a suitable output such as an sRGB display. To do this, enable sRGB conversion in the current [Environment](https://docs.godotengine.org/en/stable/classes/class_environment.html#class-environment) (more on that below).
...
HDR settings can be found in the [Environment](https://docs.godotengine.org/en/stable/classes/class_environment.html#class-environment) resource. Most of the time, these are found inside a [WorldEnvironment](https://docs.godotengine.org/en/stable/classes/class_worldenvironment.html#class-worldenvironment) node or set in a Camera node. For more information, see [Environment and post-processing](https://docs.godotengine.org/en/stable/tutorials/3d/environment_and_post_processing.html#doc-environment-and-post-processing).
