...
source: "https://docs.godotengine.org/en/stable/tutorials/3d/using_transforms.html"
created: 2026-06-19
description: "Introduction: If you have never made 3D games before, working with rotations in three dimensions can be confusing at first. Coming from 2D, the natural way of thinking is along the lines of\"Oh..."
words: 1965
tags:
  - 3d
  - transforms
...
![../../_images/transforms_euler.webp](https://docs.godotengine.org/en/stable/_images/transforms_euler.webp)

Euler angles were introduced by mathematician Leonhard Euler in the early 1700s.

![../../_images/transforms_euler_himself.png](https://docs.godotengine.org/en/stable/_images/transforms_euler_himself.png)
...
![../../_images/transforms_gimbal.gif](https://docs.godotengine.org/en/stable/_images/transforms_gimbal.gif)
...
![../../_images/transforms_rotate1.gif](https://docs.godotengine.org/en/stable/_images/transforms_rotate1.gif)

If we were to apply rotation in the *X* axis first, and then in *Y*, the effect would be undesired:

![../../_images/transforms_rotate2.gif](https://docs.godotengine.org/en/stable/_images/transforms_rotate2.gif)
...
![../../_images/transforms_interpolate1.gif](https://docs.godotengine.org/en/stable/_images/transforms_interpolate1.gif)

But this does not always have the expected effect when using angles:

![../../_images/transforms_interpolate2.gif](https://docs.godotengine.org/en/stable/_images/transforms_interpolate2.gif)
...
![../../_images/transforms_camera.png](https://docs.godotengine.org/en/stable/_images/transforms_camera.png)

One way to visualize a transform is to look at an object's 3D gizmo while in "local space" mode.

![../../_images/transforms_local_space.png](https://docs.godotengine.org/en/stable/_images/transforms_local_space.png)
...
![../../_images/transforms_gizmo.png](https://docs.godotengine.org/en/stable/_images/transforms_gizmo.png)

For more information on the mathematics of vectors and transforms, please read the [Vector math](https://docs.godotengine.org/en/stable/tutorials/math/vector_math.html#doc-vector-math) tutorials.
...
Is the enemy looking at the player? Use the dot product for this (see the [Vector math](https://docs.godotengine.org/en/stable/tutorials/math/vector_math.html#doc-vector-math) tutorial for an explanation of the dot product):
