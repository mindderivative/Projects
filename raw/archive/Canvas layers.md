---
title: "Canvas layers"
source: "https://docs.godotengine.org/en/stable/tutorials/2d/canvas_layers.html"
created: 2026-06-19
description: "Viewport and Canvas items: CanvasItem is the base for all 2D nodes, be it regular 2D nodes, such as Node2D, or Control. Both inherit from CanvasItem. You can arrange canvas items in trees. Each ite..."
words: 461
tags:
  - 2d
  - canvas
...
[CanvasItem](https://docs.godotengine.org/en/stable/classes/class_canvasitem.html#class-canvasitem) is the base for all 2D nodes, be it regular 2D nodes, such as [Node2D](https://docs.godotengine.org/en/stable/classes/class_node2d.html#class-node2d), or [Control](https://docs.godotengine.org/en/stable/classes/class_control.html#class-control). Both inherit from [CanvasItem](https://docs.godotengine.org/en/stable/classes/class_canvasitem.html#class-canvasitem). You can arrange canvas items in trees. Each item will inherit its parent's transform: when the parent moves, its children move too.

CanvasItem nodes, and nodes inheriting from them, are direct or indirect children of a [Viewport](https://docs.godotengine.org/en/stable/classes/class_viewport.html#class-viewport), that displays them.

The Viewport's property [Viewport.canvas\_transform](https://docs.godotengine.org/en/stable/classes/class_viewport.html#class-viewport-property-canvas-transform), allows to apply a custom [Transform2D](https://docs.godotengine.org/en/stable/classes/class_transform2d.html#class-transform2d) transform to the CanvasItem hierarchy it contains. Nodes such as [Camera2D](https://docs.godotengine.org/en/stable/classes/class_camera2d.html#class-camera2d) work by changing that transform.
...
![../../_images/canvaslayers.png](https://docs.godotengine.org/en/stable/_images/canvaslayers.png)
