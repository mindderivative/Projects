...
source: "https://docs.godotengine.org/en/stable/tutorials/3d/visibility_ranges.html#configuration-tips"
created: 2026-06-20
description: "Along with Mesh level of detail (LOD) and Occlusion culling, visibility ranges are another tool to improve performance in large, complex 3D scenes. On this page, you'll learn: What visibility ..."
words: 1774
---
Along with [Mesh level of detail (LOD)](https://docs.godotengine.org/en/stable/tutorials/3d/mesh_lod.html#doc-mesh-lod) and [Occlusion culling](https://docs.godotengine.org/en/stable/tutorials/3d/occlusion_culling.html#doc-occlusion-culling), visibility ranges are another tool to improve performance in large, complex 3D scenes.
...
> [!note] See also
> If you only need meshes to become less detailed over distance, but don't have manually authored LOD meshes, consider relying on automatic [Mesh level of detail (LOD)](https://docs.godotengine.org/en/stable/tutorials/3d/mesh_lod.html#doc-mesh-lod) instead.
> 
...
- **Begin:** The instance will be hidden when the camera is closer to the *center of the instance's AABB* (axis-aligned bounding box) than this value (in 3D units).
...
- **End:** The instance will be hidden when the camera is further away from the *center of the instance's AABB* than this value (in 3D units).
...
> [!note] Note
> The target of **Visibility Parent** *must* inherit from [GeometryInstance3D](https://docs.godotengine.org/en/stable/classes/class_geometryinstance3d.html#class-geometryinstance3d).
> 
...
Fade mode is automatically handled by the **Visibility Parent** property, so that the child nodes only become hidden once the parent node is fully faded out. This is done to minimize visible pop-in. Depending on your HLOD setup, you may want to try both the **Self** and **Dependencies**.
...
- No visual glitches due to [transparency sorting issues](https://docs.godotengine.org/en/stable/tutorials/3d/3d_rendering_limitations.html#doc-3d-rendering-limitations-transparency-sorting) during LOD transitions.
