...
created: 2026-06-19
description: "Introduction: Since Godot has no restrictions on project structure or filesystem usage, organizing files when learning the engine can seem challenging. This tutorial suggests a workflow which shoul..."
words: 702
tags:
  - bestPractices
  - organization
...
- Use **snake\_case** for folder and file names (with the exception of C# scripts). This sidesteps case sensitivity issues that can crop up after exporting a project on Windows. C# scripts are an exception to this rule, as the convention is to name them after the class name which should be in PascalCase.
...
Because of this, assets are now transparently imported from within the project folder. See [Import process](https://docs.godotengine.org/en/stable/tutorials/assets_pipeline/import_process.html#doc-import-process) for more details on how importing works in Godot.
