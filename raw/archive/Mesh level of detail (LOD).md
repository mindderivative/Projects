...
source: "https://docs.godotengine.org/en/stable/tutorials/3d/mesh_lod.html#introduction"
created: 2026-06-20
description: "Level of detail (LOD) is one of the most important ways to optimize rendering performance in a 3D project, along with Occlusion culling. On this page, you'll learn: How mesh LOD can improve yo..."
words: 1173
---
Level of detail (LOD) is one of the most important ways to optimize rendering performance in a 3D project, along with [Occlusion culling](https://docs.godotengine.org/en/stable/tutorials/3d/occlusion_culling.html#doc-occlusion-culling).
...
> [!note] See also
> You can see how mesh LOD works in action using the [Occlusion Culling and Mesh LOD demo project](https://github.com/godotengine/godot-demo-projects/tree/master/3d/occlusion_culling_mesh_lod).
...
![From most detailed (left) to least detailed (right), shaded view](https://docs.godotengine.org/en/stable/_images/mesh_lod_comparison_shaded.png)
...
![From most detailed (left) to least detailed (right), wireframe view](https://docs.godotengine.org/en/stable/_images/mesh_lod_comparison_wireframe.png)

From most detailed (left) to least detailed (right), wireframe view 

> [!note] See also
> If you need to manually configure level of detail with artist-created meshes, use [Visibility ranges (HLOD)](https://docs.godotengine.org/en/stable/tutorials/3d/visibility_ranges.html#doc-visibility-ranges) instead of automatic mesh LOD.
...
![Changing the import type on an OBJ file in the Import dock](https://docs.godotengine.org/en/stable/_images/mesh_lod_obj_import.png)
...
> 
> See [Importing 3D scenes](https://docs.godotengine.org/en/stable/tutorials/assets_pipeline/importing_3d_scenes/import_configuration.html#doc-importing-3d-scenes-using-the-import-dock) for more information.
...
![Disabling mesh LOD in the 3D viewport's top-left menu](https://docs.godotengine.org/en/stable/_images/mesh_lod_disable_lod.png)
...
> 
> As a result, unlike [Visibility ranges (HLOD)](https://docs.godotengine.org/en/stable/tutorials/3d/visibility_ranges.html#doc-visibility-ranges), you don't need to do anything specific in your project to take camera FOV and viewport resolution into account.
