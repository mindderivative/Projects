---
title: "3D Particle attractors"
source: "https://docs.godotengine.org/en/stable/tutorials/3d/particles/attractors.html"
created: 2026-06-20
description: "Particle attractors Particle attractors are nodes that apply a force to all particles within their reach. They pull particles closer or push them away based on the direction of that force. There ar..."
words: 1129
---
![Particle attractors](https://docs.godotengine.org/en/stable/_images/particle_attractor.webp)

Particle attractors

Particle attractors are nodes that apply a force to all particles within their reach. They pull particles closer or push them away based on the direction of that force. There are three types of attractors: [GPUParticlesAttractorBox3D](https://docs.godotengine.org/en/stable/classes/class_gpuparticlesattractorbox3d.html#class-gpuparticlesattractorbox3d), [GPUParticlesAttractorSphere3D](https://docs.godotengine.org/en/stable/classes/class_gpuparticlesattractorsphere3d.html#class-gpuparticlesattractorsphere3d), and [GPUParticlesAttractorVectorField3D](https://docs.godotengine.org/en/stable/classes/class_gpuparticlesattractorvectorfield3d.html#class-gpuparticlesattractorvectorfield3d). You can instantiate them at runtime and change their properties from gameplay code; you can even animate and combine them for complex attraction effects.
...
![Common particle attractor properties](https://docs.godotengine.org/en/stable/_images/particle_attractor_common.webp)
...
![Different attractor attenuation curves](https://docs.godotengine.org/en/stable/_images/particle_attractor_curve.webp)
...
![Different attractor directionality values](https://docs.godotengine.org/en/stable/_images/particle_attractor_direction.webp)

No directionality (left) vs. full directionality (right). Notice how the particles move along the attractor's local Z-axis. 

The `Cull Mask` property controls which particle systems are affected by an attractor based on each system's [visibility layers](https://docs.godotengine.org/en/stable/classes/class_visualinstance3d.html#class-visualinstance3d). A particle system is only affected by an attractor if at least one of the system's visibility layers is enabled in the attractor's cull mask.

## Box attractors

![Particle attractor box](https://docs.godotengine.org/en/stable/_images/particle_attractor_box_entry.webp)
...
![Box attractor parts particle field](https://docs.godotengine.org/en/stable/_images/particle_attractor_box.webp)

A box attractor with a negative strength value parts a particle field as it moves through it. 

## Sphere attractors

![Particle attractor sphere](https://docs.godotengine.org/en/stable/_images/particle_attractor_sphere_entry.webp)
...
![Sphere attractor parts particle field](https://docs.godotengine.org/en/stable/_images/particle_attractor_sphere.webp)

A sphere attractor with a negative strength value parts a particle field as it moves through it. 

## Vector field attractors

![Particle attractor vector field](https://docs.godotengine.org/en/stable/_images/particle_attractor_vector_entry.webp)
...
> ![Mapping from texture to vector field](https://docs.godotengine.org/en/stable/_images/particle_attractor_vector_mapping.webp)
> 
...
![Vector field attractor in a field of particles](https://docs.godotengine.org/en/stable/_images/particle_attractor_vector.webp)
