---
title: "Introduction to 2D"
source: "https://docs.godotengine.org/en/stable/tutorials/2d/introduction_to_2d.html"
created: 2026-06-19
description: "Godot's 2D game development tools include a dedicated 2D rendering engine, physics system, and features tailored specifically for creating 2D experiences. You can efficiently design levels wit..."
words: 2728
tags:
  - 2d
---
...
![../../_images/2d_platformer_demo.webp](https://docs.godotengine.org/en/stable/_images/2d_platformer_demo.webp)
...
> [!tip] Tip
> If you would like to get an introduction to 3D, see [Introduction to 3D](https://docs.godotengine.org/en/stable/tutorials/3d/introduction_to_3d.html#doc-introduction-to-3d).
...
![../../_images/2d_editor_viewport.webp](https://docs.godotengine.org/en/stable/_images/2d_editor_viewport.webp)

Similar to 3D, you can use the tabs below the workspace selector to change between currently opened scenes or create a new one using the plus (+) button. The left and right docks should be familiar from.
...
![../../_images/2d_toolbar.webp](https://docs.godotengine.org/en/stable/_images/2d_toolbar.webp)
...
- **Scale Mode** (S): Enables scaling and displays scaling gizmos in both axes for the selected node(s). See for more details.
...
- **Rotation pivot**: Sets the rotation pivot to rotate node(s) around. An added node has its rotation pivot at `x: 0`, `y: 0`, by default, with exceptions. For example, the default pivot for a [Sprite2D](https://docs.godotengine.org/en/stable/classes/class_sprite2d.html#class-sprite2d) is its center if the `centered` property is set to `true`. If you would like to change the rotation pivot of a node, click this button and choose a new location by left clicking. The node rotates considering this point. If you have multiple nodes selected, this icon will add a temporary pivot to be used commonly by all selected nodes. Pressing Shift and clicking this button will create the pivot at the center of selected nodes. If any of the snap options are enabled, the pivot will also snap to them when dragged.
...
![../../_images/2d_ruler_with_snap.webp](https://docs.godotengine.org/en/stable/_images/2d_ruler_with_snap.webp)
...
![../../_images/2d_snapping_options_menu.webp](https://docs.godotengine.org/en/stable/_images/2d_snapping_options_menu.webp)
...
![../../_images/2d_snapping_options.webp](https://docs.godotengine.org/en/stable/_images/2d_snapping_options.webp)
...
> [!note] See also
> To learn more about Skeletons, see [Cutout animation](https://docs.godotengine.org/en/stable/tutorials/animation/cutout_animation.html#doc-cutout-animation).

- **View** menu: Provides options to control the viewport view. Since its options depend heavily on the viewport, it is covered in the section.
...
![../../_images/2d_editor_viewport_with_viewmenu.webp](https://docs.godotengine.org/en/stable/_images/2d_editor_viewport_with_viewmenu.webp)
...
![../../_images/2d_editor_guidelines.webp](https://docs.godotengine.org/en/stable/_images/2d_editor_guidelines.webp)
...
- **Show Rulers**: Toggles the visibility of horizontal and vertical rulers. See more on rulers.
- **Show Guides**: Toggles the visibility of created guides. See for on how to create them.
...
[CanvasItem](https://docs.godotengine.org/en/stable/classes/class_canvasitem.html#class-canvasitem) is the base node for 2D. [Node2D](https://docs.godotengine.org/en/stable/classes/class_node2d.html#class-node2d) is the base node for 2D game objects, and [Control](https://docs.godotengine.org/en/stable/classes/class_control.html#class-control) is the base node for everything GUI. For 3D, Godot uses the [Node3D](https://docs.godotengine.org/en/stable/classes/class_node3d.html#class-node3d) node.

## Displaying 3D nodes in 2D

It is possible to display 3D nodes in a 2D scene by using a [SubViewport](https://docs.godotengine.org/en/stable/classes/class_subviewport.html#class-subviewport). You can see this in the demo [3D in 2D Viewport](https://godotengine.org/asset-library/asset/2804).

![../../_images/3d_in_2d_demo_editor.webp](https://docs.godotengine.org/en/stable/_images/3d_in_2d_demo_editor.webp)
