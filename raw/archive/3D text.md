---
title: "3D text"
source: "https://docs.godotengine.org/en/stable/tutorials/3d/3d_text.html#introduction"
created: 2026-06-20
description: "Introduction: In a project, there may be times when text needs to be created as part of a 3D scene and not just in the HUD. Godot provides 2 methods to do this: the Label3D node and the TextMesh re..."
words: 1078
---
## Introduction
...
> [!note] See also
> You can see 3D text in action using the [3D Labels and Texts demo project](https://github.com/godotengine/godot-demo-projects/tree/master/3d/labels_and_texts).
> 
> This page does **not** cover how to display a GUI scene within a 3D environment. For information on how to achieve that, see the [GUI in 3D](https://github.com/godotengine/godot-demo-projects/tree/master/viewport/gui_in_3d) demo project.

## Label3D

![../../_images/label_3d.png](https://docs.godotengine.org/en/stable/_images/label_3d.png)
...
> [!note] See also
> See [Using Fonts](https://docs.godotengine.org/en/stable/tutorials/ui/gui_using_fonts.html#doc-gui-using-fonts) for guidelines on configuring font imports.
...
See [Transparency sorting](https://docs.godotengine.org/en/stable/tutorials/3d/3d_rendering_limitations.html#doc-3d-rendering-limitations-transparency-sorting) section in the 3D rendering limitations page for more information.

Text rendering quality can also suffer when the Label3D is viewed at a distance. To improve text rendering quality, [enable mipmaps on the font](https://docs.godotengine.org/en/stable/tutorials/ui/gui_using_fonts.html#doc-using-fonts-mipmaps) or [switch the font to use MSDF rendering](https://docs.godotengine.org/en/stable/tutorials/ui/gui_using_fonts.html#doc-using-fonts-msdf).

## TextMesh

![../../_images/text_mesh.png](https://docs.godotengine.org/en/stable/_images/text_mesh.png)
...
![../../_images/text_mesh_texture.png](https://docs.godotengine.org/en/stable/_images/text_mesh_texture.png) ![../../_images/text_mesh_textured.png](https://docs.godotengine.org/en/stable/_images/text_mesh_textured.png)
...
- Antialiasing the text rendering requires a full-scene antialiasing method to be enabled such as MSAA, FXAA and temporal antialiasing (TAA). If no antialiasing method is enabled, text will appear grainy, especially at a distance. See [3D antialiasing](https://docs.godotengine.org/en/stable/tutorials/3d/3d_antialiasing.html#doc-3d-antialiasing) for more information.

## Projected Label node (or any other Control)

There is a last solution that is more complex to set up, but provides the most flexibility: projecting a 2D node onto 3D space. This can be achieved using the return value of [unproject\_position](https://docs.godotengine.org/en/stable/classes/class_camera3d.html#class-camera3d-method-unproject-position) method on a Camera3D node in a script's `_process()` function. This return value should then be used to set the `position` property of a Control node.
