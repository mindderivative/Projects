...
source: https://docs.godotengine.org/en/stable/tutorials/2d/2d_lights_and_shadows.html
created: 2026-06-19
description: "Introduction: By default, 2D scenes in Godot are unshaded, with no lights and shadows visible. While this is fast to render, unshaded scenes can look bland. Godot provides the ability to use real-t..."
words: 2672
tags: 
  - 2d
  - rendering
...
![No 2D lights or shadows, scene is unshaded](https://docs.godotengine.org/en/stable/_images/2d_lights_and_shadows_disabled.webp)

No 2D lights or shadows, scene is unshaded 

![2D lights enabled (without shadows)](https://docs.godotengine.org/en/stable/_images/2d_lights_and_shadows_enabled_no_shadows.webp)

2D lights enabled (without shadows) 

![2D lights and shadows enabled](https://docs.godotengine.org/en/stable/_images/2d_lights_and_shadows_enabled.webp)
...
- [CanvasModulate](https://docs.godotengine.org/en/stable/classes/class_canvasmodulate.html#class-canvasmodulate) (to darken the rest of the scene)
- [PointLight2D](https://docs.godotengine.org/en/stable/classes/class_pointlight2d.html#class-pointlight2d) (for omnidirectional or spot lights)
- [DirectionalLight2D](https://docs.godotengine.org/en/stable/classes/class_directionallight2d.html#class-directionallight2d) (for sunlight or moonlight)
- [LightOccluder2D](https://docs.godotengine.org/en/stable/classes/class_lightoccluder2d.html#class-lightoccluder2d) (for light shadow casters)
- Other 2D nodes that receive lighting, such as Sprite2D or TileMapLayer.

[CanvasModulate](https://docs.godotengine.org/en/stable/classes/class_canvasmodulate.html#class-canvasmodulate) is used to darken the scene by specifying a color that will act as the base "ambient" color. This is the final lighting color in areas that are *not* reached by any 2D light. Without a CanvasModulate node, the final scene would look too bright as 2D lights would only brighten the existing unshaded appearance (which appears fully lit).

[Sprite2Ds](https://docs.godotengine.org/en/stable/classes/class_sprite2d.html#class-sprite2d) are used to display the textures for the light blobs, the background, and for the shadow casters.

[PointLight2Ds](https://docs.godotengine.org/en/stable/classes/class_pointlight2d.html#class-pointlight2d) are used to light the scene. The way a light typically works is by adding a selected texture over the rest of the scene to simulate lighting.

[LightOccluder2Ds](https://docs.godotengine.org/en/stable/classes/class_lightoccluder2d.html#class-lightoccluder2d) are used to tell the shader which parts of the scene cast shadows. These occluders can be placed as independent nodes or can be part of a TileMapLayer node.

The shadows appear only on areas covered by the [PointLight2D](https://docs.godotengine.org/en/stable/classes/class_pointlight2d.html#class-pointlight2d) and their direction is based on the center of the [Light](https://docs.godotengine.org/en/stable/classes/class_pointlight2d.html#class-pointlight2d).
...
![Neutral point light texture](https://docs.godotengine.org/en/stable/_images/2d_lights_and_shadows_neutral_point_light.webp)
...
> 
> For more information on canvas item shaders, see [CanvasItem shaders](https://docs.godotengine.org/en/stable/tutorials/shaders/shader_reference/canvas_item_shader.html#doc-canvas-item-shader).

![Hard shadows](https://docs.godotengine.org/en/stable/_images/2d_lights_and_shadows_hard_shadow.webp)

Hard shadows 

![Soft shadows (PCF13, Filter Smooth 1.5)](https://docs.godotengine.org/en/stable/_images/2d_lights_and_shadows_soft_shadow.webp)

Soft shadows (PCF13, Filter Smooth 1.5) 

![Soft shadows with streaking artifacts due to Filter Smooth being too high (PCF5, Filter Smooth 4)](https://docs.godotengine.org/en/stable/_images/2d_lights_and_shadows_soft_shadow_streaks.webp)
...
> [!tip] Tip
> If you don't have normal or specular maps for your sprites, you can generate them using the free and open source [Laigter](https://azagaya.itch.io/laigter) tool.
...
![Creating a CanvasTexture resource for a Sprite2D node](https://docs.godotengine.org/en/stable/_images/2d_lights_and_shadows_create_canvastexture.webp)
