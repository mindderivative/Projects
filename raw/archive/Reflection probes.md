...
source: "https://docs.godotengine.org/en/stable/tutorials/3d/global_illumination/reflection_probes.html"
created: 2026-06-20
description: "As stated in the Standard Material 3D and ORM Material 3D, objects can show reflected and/or diffuse light. Reflection probes are used as a source of reflected and ambient light for objects inside ..."
words: 1279
---
As stated in the [Standard Material 3D and ORM Material 3D](https://docs.godotengine.org/en/stable/tutorials/3d/standard_material_3d.html#doc-standard-material-3d), objects can show reflected and/or diffuse light. Reflection probes are used as a source of reflected *and* ambient light for objects inside their area of influence. They can be used to provide more accurate reflections than [VoxelGI](https://docs.godotengine.org/en/stable/tutorials/3d/global_illumination/using_voxel_gi.html#doc-using-voxel-gi) and [SDFGI](https://docs.godotengine.org/en/stable/tutorials/3d/global_illumination/using_sdfgi.html#doc-using-sdfgi) while being fairly cheap on system resources.

Since reflection probes can also store ambient light, they can be used as a low-end alternative to VoxelGI and SDFGI when [baked lightmaps](https://docs.godotengine.org/en/stable/tutorials/3d/global_illumination/using_lightmap_gi.html#doc-using-lightmap-gi) aren't viable (e.g. in procedurally generated levels).
...
![Reflections in a room using ReflectionProbe only.](https://docs.godotengine.org/en/stable/_images/reflection_probes_reflection_probe.webp)

Reflections in a room using ReflectionProbe only. Notice how small details don't have any reflections. 

![Reflections in a room using screen-space reflections only.](https://docs.godotengine.org/en/stable/_images/reflection_probes_ssr.webp)
...
![Reflections in a room using ReflectionProbe and screen-space reflections together.](https://docs.godotengine.org/en/stable/_images/reflection_probes_reflection_probe_ssr.webp)
...
- Add a [ReflectionProbe](https://docs.godotengine.org/en/stable/classes/class_reflectionprobe.html#class-reflectionprobe) node.
