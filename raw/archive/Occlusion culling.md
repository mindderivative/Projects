...
source: "https://docs.godotengine.org/en/stable/tutorials/3d/occlusion_culling.html#why-use-occlusion-culling"
created: 2026-06-20
description: "In a 3D rendering engine, occlusion culling is the process of performing hidden geometry removal. On this page, you'll learn: What are the advantages and pitfalls of occlusion culling., How to..."
words: 1614
---
...
> [!note] See also
> You can see how occlusion culling works in action using the [Occlusion Culling and Mesh LOD demo project](https://github.com/godotengine/godot-demo-projects/tree/master/3d/occlusion_culling_mesh_lod).
...
![Example scene with an occlusion culling-friendly layout](https://docs.godotengine.org/en/stable/_images/occlusion_culling_scene_example.png)
...
![Example scene with occlusion culling disabled (wireframe)](https://docs.godotengine.org/en/stable/_images/occlusion_culling_disabled.png)
...
Remember to keep the simplification value reasonable. Values that are too high for the level's geometry may cause incorrect occlusion culling to occur, as in.
...
This can also happen because dynamic objects were included in the bake, even though they shouldn't be. Use the to look for occluder shapes that shouldn't be present, then.
