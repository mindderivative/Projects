---
title: "Script Editor"
source: "https://docs.godotengine.org/en/stable/tutorials/editor/script_editor.html"
created: 2026-06-19
description: "Introduction: Godot Engine's script editor is a powerful and fully-integrated text editor that not only streamlines the process of writing and debugging code written in GDScript but also allow..."
words: 3471
tags:
  - editor
  - interface
...
> [!note] Note
> If you would like to use an external text editor or prefer to use C# in your project, see [Using an external text editor](https://docs.godotengine.org/en/stable/tutorials/editor/external_editor.html#doc-external-editor) and [Configuring an external editor](https://docs.godotengine.org/en/stable/tutorials/scripting/c_sharp/c_sharp_basics.html#doc-c-sharp-setup-external-editor).
...
![../../_images/editor_ui_script_editor_open.webp](https://docs.godotengine.org/en/stable/_images/editor_ui_script_editor_open.webp)
...
![../../_images/editor_ui_script_editor_menu.webp](https://docs.godotengine.org/en/stable/_images/editor_ui_script_editor_menu.webp)
...
Many of the actions performed in the text editor can also be executed using shortcuts. The actions show their corresponding shortcuts next to them. Within Godot itself, you can find and rebind all shortcuts by going to.
...
![../../_images/editor_ui_script_editor_script_panel.webp](https://docs.godotengine.org/en/stable/_images/editor_ui_script_editor_script_panel.webp)

Below the menus, on the left panel, you will see a list of opened files and documentation pages. Depending on the file type, this list will have an icon next to the file name. For example, the icon means that it is a GDScript. the means it is a C# script. The means that this is a built-in class reference. Finally, the means it is a currently running script (See [tool annotation](https://docs.godotengine.org/en/stable/tutorials/plugins/running_code_in_the_editor.html#doc-running-code-in-the-editor) for more on this). Hovering a file will show a tooltip with its relative location in the project folder.
...
![../../_images/text_editor_menu.webp](https://docs.godotengine.org/en/stable/_images/text_editor_menu.webp)

The **File** menu provides the following options:

![../../_images/text_editor_file_menu.webp](https://docs.godotengine.org/en/stable/_images/text_editor_file_menu.webp)
...
- **Soft Reload Tool Script**: If the selected script is a [tool](https://docs.godotengine.org/en/stable/tutorials/plugins/running_code_in_the_editor.html#doc-running-code-in-the-editor), reloads the script to execute it again.
...
- **Run**: If the script extends [EditorScript](https://docs.godotengine.org/en/stable/classes/class_editorscript.html#class-editorscript) and intended to be executed without running the project, this option runs the script. See [Running one-off scripts using EditorScript](https://docs.godotengine.org/en/stable/tutorials/plugins/running_code_in_the_editor.html#doc-running-code-in-the-editor-editorscript) for more.
- **Toggle Scripts Panel**: Shows or hides the script panel located on the left side of the text editor, allowing you to expand the available coding area. More on the Scripts Panel is explained.

The **Edit** menu provides several options for line operations:

![../../_images/text_editor_edit_menu.webp](https://docs.godotengine.org/en/stable/_images/text_editor_edit_menu.webp)
...
- **Folding**: Provides a set of folding options for the selected text. Depending on the opened file, the options might also be directly in the Edit menu, instead of a submenu.
	- **Fold/Unfold Line\***: If the code in the current line has a code block or code region beneath it, it hides this block by collapsing the lines. You can then unfold it using this option again, using the ">" arrow next to the line number in the coding area, or clicking on the ellipsis "..." icon at the end of the folded line.
		...
		- **Create Code Region\***: Wraps the selected text in a foldable code region to improve the readability of larger scripts. See [Built-in types](https://docs.godotengine.org/en/stable/tutorials/scripting/gdscript/gdscript_basics.html#doc-gdscript-builtin-types) for more.
...
![../../_images/text_editor_search_menu.webp](https://docs.godotengine.org/en/stable/_images/text_editor_search_menu.webp)
...
![../../_images/editor_ui_script_editor_replaceinfiles.webp](https://docs.godotengine.org/en/stable/_images/editor_ui_script_editor_replaceinfiles.webp)
...
![../../_images/editor_ui_script_editor_replace_all.webp](https://docs.godotengine.org/en/stable/_images/editor_ui_script_editor_replace_all.webp)
...
![../../_images/text_editor_goto_menu.webp](https://docs.godotengine.org/en/stable/_images/text_editor_goto_menu.webp)
...
**Debug** menu offers actions which can be used while debugging. See [Script editor debug tools and options](https://docs.godotengine.org/en/stable/tutorials/scripting/debug/overview_of_debugging_tools.html#doc-debugger-tools-and-options) for more.

### Coding area

> [!note] Note
> This section will only cover the basics of the coding area in terms of the user interface. To learn more about scripting in Godot, refer to the [GDScript](https://docs.godotengine.org/en/stable/tutorials/scripting/gdscript/index.html#doc-gdscript) or documentation.

![../../_images/editor_ui_script_editor_coding_area.webp](https://docs.godotengine.org/en/stable/_images/editor_ui_script_editor_coding_area.webp)
