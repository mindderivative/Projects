---
title: "Using decals"
source: "https://docs.godotengine.org/en/stable/tutorials/3d/using_decals.html#use-cases"
created: 2026-06-20
description: "Decals are projected textures that apply on opaque or transparent surfaces in 3D. This projection happens in real-time and doesn't rely on mesh generation. This allows you to move decals every..."
words: 1882
---
> [!note] Note
...
> [!note] See also
> The Godot demo projects repository contains a [3D decals demo](https://github.com/godotengine/godot-demo-projects/tree/master/3d/decals).
> 
> If you're looking to write arbitrary 3D text on top of a surface, use [3D text](https://docs.godotengine.org/en/stable/tutorials/3d/3d_text.html#doc-3d-text) placed close to a surface instead of a Decal node.
...
![Dirt added on top of level geometry using decals](https://docs.godotengine.org/en/stable/_images/decals_dirt.webp)
...
![Blob shadow under object comparison](https://docs.godotengine.org/en/stable/_images/decals_blob_shadow.webp)
...
![VisualInstance3D Sorting Offset comparison on Decals](https://docs.godotengine.org/en/stable/_images/decals_sorting_offset.webp)
