...
source: "https://docs.godotengine.org/en/stable/tutorials/3d/resolution_scaling.html#why-use-resolution-scaling"
created: 2026-06-20
description: "Why use resolution scaling?: With the ever-increasing rendering complexity of modern games, rendering at native resolution isn't always viable anymore, especially on lower-end GPUs. Resolution..."
words: 1449
---
...
> [!note] See also
> You can compare resolution scaling modes and factors in action using the [3D Antialiasing demo project](https://github.com/godotengine/godot-demo-projects/tree/master/3d/antialiasing).

> [!note] Note
> Resolution scaling is currently not available for 2D rendering, but it can be simulated using the `viewport` stretch mode. See [Multiple resolutions](https://docs.godotengine.org/en/stable/tutorials/rendering/multiple_resolutions.html#doc-multiple-resolutions) for more information.
...
- **FSR 1.0:** [AMD FidelityFX Super Resolution 1.0](https://gpuopen.com/fidelityfx-superresolution/). Slower, but higher quality compared to bilinear scaling. On very slow GPUs, the cost of FSR1 may be too expensive to be worth using it over bilinear scaling. *Only available when using the Forward+ renderer.*
...
![../../_images/resolution_scaling_bilinear_0.5.png](https://docs.godotengine.org/en/stable/_images/resolution_scaling_bilinear_0.5.png) ![../../_images/resolution_scaling_fsr1_0.5.png](https://docs.godotengine.org/en/stable/_images/resolution_scaling_fsr1_0.5.png) ![../../_images/resolution_scaling_fsr2_0.5.webp](https://docs.godotengine.org/en/stable/_images/resolution_scaling_fsr2_0.5.webp)
...
![../../_images/resolution_scaling_bilinear_msaa_4x_0.5.png](https://docs.godotengine.org/en/stable/_images/resolution_scaling_bilinear_msaa_4x_0.5.png) ![../../_images/resolution_scaling_fsr1_msaa_4x_0.5.png](https://docs.godotengine.org/en/stable/_images/resolution_scaling_fsr1_msaa_4x_0.5.png) ![../../_images/resolution_scaling_fsr2_msaa_4x_0.5.webp](https://docs.godotengine.org/en/stable/_images/resolution_scaling_fsr2_msaa_4x_0.5.webp)
...
The rendering scale can be adjusted at runtime by changing the `scaling_3d_scale` property on a [Viewport](https://docs.godotengine.org/en/stable/classes/class_viewport.html#class-viewport) node.

Resolution scales *above* `1.0` can be used for supersample antialiasing (SSAA). This will provide antialiasing at a *very* high performance cost, and is **not recommended** for most use cases. See [3D antialiasing](https://docs.godotengine.org/en/stable/tutorials/3d/3d_antialiasing.html#doc-3d-antialiasing) for more information.
...
The texture LOD bias can manually be changed by adjusting the **Rendering > Textures > Default Filters > Texture Mipmap Bias** advanced project setting. It can also be changed at runtime on [Viewports](https://docs.godotengine.org/en/stable/classes/class_viewport.html#class-viewport) by adjusting the `texture_mipmap_bias` property.
...
![../../_images/resolution_scaling_texture_mipmap_bias_comparison.png](https://docs.godotengine.org/en/stable/_images/resolution_scaling_texture_mipmap_bias_comparison.png)
...
See the [Performance](https://docs.godotengine.org/en/stable/tutorials/performance/index.html#doc-performance) tutorials for more information.
