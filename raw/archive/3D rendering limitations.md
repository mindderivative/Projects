...
source: "https://docs.godotengine.org/en/stable/tutorials/3d/3d_rendering_limitations.html"
created: 2026-06-20
description: "Introduction: Due to their focus on performance, real-time rendering engines have many limitations. Godot's renderer is no exception. To work effectively with those limitations, you need to un..."
words: 1018
---
## Introduction
...
- If using the Forward+ or Forward Mobile rendering methods, enable [Use Debanding](https://docs.godotengine.org/en/stable/classes/class_projectsettings.html#class-projectsettings-property-rendering-anti-aliasing-quality-use-debanding) in **Project Settings > Rendering > Anti Aliasing**. This applies a fullscreen debanding shader as a post-processing effect and is very cheap.
...
![Color banding comparison (contrast increased for more visibility)](https://docs.godotengine.org/en/stable/_images/3d_rendering_limitations_banding.webp)

Color banding comparison (contrast increased for more visibility) 

> [!note] See also
> See [Banding in Games: A Noisy Rant (PDF)](https://loopit.dk/banding_in_games.pdf) for more details about banding and ways to combat it.
...
![Transparency sorting comparison (alpha-blended materials on the left, alpha scissor materials on the right)](https://docs.godotengine.org/en/stable/_images/3d_rendering_limitations_transparency_sorting.webp)
